...
public class AtualizaUsuarioSteps {

    private Response response;
    private AtualizaUsuarioDTO request;
    ...
    public void tenhoOsDadosValidosDeUmUsuarioQueJaEstaCadastrado() {
        ...
        this.request = new AtualizaUsuarioDTO(
                "testeSenha",
    ...
    public void tenhoOsDadosValidosDeUmUsuario() {
        this.login = this.pegaLogin();
        this.request = new AtualizaUsuarioDTO(
                "testeSenha",
                UsuarioRoleEnum.ADMIN
    ...
    public void atualizoEsseUsuario() {
        RestAssured.baseURI = "http://localhost:8080";
        this.response = given()
                .contentType(MediaType.APPLICATION_JSON_VALUE)
                ...
                .body(this.request)
                .when()
                .put(URL_USUARIO_COM_LOGIN.replace("{login}", this.login));
    }

    @Entao("recebo uma resposta que o usuario foi atualizado com sucesso")
    public void receboUmaRespostaQueOUsuarioFoiAtualizadoComSucesso() {
        this.response
                .prettyPeek()
                .then()
    ...
    public void receboUmaRespostaQueOUsuarioNaoEstaCadastrado() {
        this.response
                .prettyPeek()
                .then()
